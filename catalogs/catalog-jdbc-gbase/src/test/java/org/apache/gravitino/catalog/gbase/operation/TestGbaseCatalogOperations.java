...
import org.apache.gravitino.catalog.gbase.GbaseCatalog;
import org.apache.gravitino.catalog.jdbc.JdbcCatalogOperations;
import org.junit.jupiter.api.Tag;
import org.junit.jupiter.api.Test;

@Tag("gravitino-docker-test")
public class TestGbaseCatalogOperations extends TestGbase {
  ...
  public void testCheckJDBCDriver() throws SQLException {
    ...
    catalogOperations.initialize(getGbaseCatalogProperties(), null, new GbaseCatalog());
  }
}
