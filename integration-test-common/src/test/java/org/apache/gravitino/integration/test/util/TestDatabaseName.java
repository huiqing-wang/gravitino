...
public enum TestDatabaseName {
  ...
  PHOENIX_PHOENIX_ABSTRACT_IT,
  PHOENIX_CATALOG_PHOENIX_IT,
  PHOENIX_AUDIT_CATALOG_PHOENIX_IT,

  GBASE_GBASE_ABSTRACT_IT,
  GBASE_CATALOG_GBASE_IT,
  GBASE_AUDIT_CATALOG_GBASE_IT
}
